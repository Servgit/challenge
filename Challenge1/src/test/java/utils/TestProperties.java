...
public class TestProperties {
    ...
    public String getEndpoints(String environment, String endpoint){
        ...
        try {
            Object obj = parser.parse(new FileReader("C:\\Users\\Android\\eclipse-workspace\\Challenge1\\src\\test\\resources\\config\\EndPoints.json"));
    ...
    public String getWebDriver(String webDriver){
        ...
        try {
            Object obj = parser.parse(new FileReader("C:\\Users\\Android\\eclipse-workspace\\Challenge1\\src\\test\\resources\\config\\AppConfig.json"));
            JSONObject jsonObject = (JSONObject) obj;
